var app = angular.module('UrlValidate', []);

app.directive('urlValidate', function () {
    return {
        restrict: 'A',
        require: '?ngModel',
        link: function (scope, elm, attrs, ngModel) {
            ...
            elm.on('blur', function () {
                ...
                var errElm = angular.element(document.querySelector('#invalidURL'))[0];
                if (errElm) {
