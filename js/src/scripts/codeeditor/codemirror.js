...
(function (global, factory) {
	...
	function modifyLayout(obj) {
        var txtarea = $('#codeeditor');
        if (txtarea && txtarea.length > 0) {
            var _h = txtarea.css('height') || 0;
            var _w = txtarea.css("width") || 0;
    ...
    function hiddenTextarea() {
        ...
        var te = elt("textarea", null, null, "height:97%;width:98%;border:solid 1px lightgrey;text-align:left; padding: 0; outline: none");
    ...
    TextareaInput.prototype.init = function (display) {
        ...
        te.id = "codeeditor";
        te.name = "codeeditor";
        te.setAttribute("oncontextmenu", "return false;");
        te.setAttribute("placeholder", cm.options.placeholder);
    ...
    TextareaInput.prototype.poll = function () {
        ...
        runInOp(cm, function () {
            ...
            var pos = cm.getCursor("to");
            //console.log(text + ',' + pos.ch + ',' + pos.line + ',' + pos.sticky);
